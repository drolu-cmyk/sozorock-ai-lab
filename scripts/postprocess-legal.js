...
const footer = '<footer class="site-footer"><div class="footer-grid"><div class="footer-brand"><a class="capability-brand footer-capability-brand" href="/" aria-label="SozoRock AI Lab home"><span>SOZOROCK</span><span>AI LAB</span></a><p>A no-cost education program of The SozoRock Foundation, Inc., a nonprofit, tax-exempt charitable organization.</p><p><a href="https://www.sozorockfoundation.org/" rel="noopener">Visit the Foundation website</a></p></div><nav class="footer-col" aria-label="Program"><h2>Program</h2><a href="/">AI Lab</a><a href="/curriculum/">Curriculum</a><a href="/#apply">Apply</a><a href="/organizations/">For organizations</a></nav><nav class="footer-col" aria-label="Policies"><h2>Policies</h2><a href="/privacy/">Privacy</a><a href="/terms/">Terms</a><a href="/accessibility/">Accessibility</a><a href="/nondiscrimination/">Nondiscrimination</a><a href="/data-rights/">Data rights</a></nav><nav class="footer-col" aria-label="Contact"><h2>Contact</h2><a href="/security/">Privacy or security concern</a><a href="/grievances/">Complaint or grievance</a><a href="/copyright/">Copyright</a><a href="/organizations/#inquiry">Contact</a></nav></div><div class="footer-bottom"><p>© 2026 The SozoRock Foundation, Inc. All rights reserved.</p></div></footer>';
...
for (const slug of slugs) {
  ...
  source = source.replaceAll('href="/assets/css/styles.css"', 'href="/assets/css/styles.css?v=20260807-2"');
  source = source.replaceAll('August 4, 2026', 'August 7, 2026');
  source = source.replaceAll('August 6, 2026', 'August 7, 2026');
  source = source.replaceAll('2026-08-04', '2026-08-07');
  source = source.replaceAll('2026-08-06', '2026-08-07');
